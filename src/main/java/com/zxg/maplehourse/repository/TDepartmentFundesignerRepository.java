...
public interface TDepartmentFundesignerRepository extends JpaRepository<TDepartmentFundesignerModel, Integer> ,JpaSpecificationExecutor {
    ...
    int deleteFundesignerById(@Param("updateUser") Integer updateUser,
                              ...
                              @Param("id") Integer id);
    Page<TDepartmentFundesignerModel> findByDelFlag(String delFlag, Pageable pageable);
